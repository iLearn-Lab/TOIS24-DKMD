...
class Dataset(data.Dataset):
    ...
    def __init__(self, task: int, context_dir, 
        ...
        # index_know_text
        path_index_know = '/home/ma-user/work/chenxiaolin/dataset/index_know.npy'
        self.index_know_dict = np.load(path_index_know, allow_pickle=True).tolist()
        # name_know_text
        path_name_know = '/home/ma-user/work/chenxiaolin/dataset/name_know.npy'
        self.name_know_dict = np.load(path_name_know, allow_pickle=True).tolist()
        # img-name_know-name
        # Origin
        # path_img_db = '/home/ma-user/work/chenxiaolin/dataset/img_db_name.npy'
        # db_cos
        path_img_db = '/home/ma-user/work/chenxiaolin/dataset/img_db_name_cos.npy'
        self.image_content = np.load(path_img_db, allow_pickle=True).tolist()
        self.path_img_fea = '/home/ma-user/work/chenxiaolin/Img_Feature/'
        self.path_img_jpg = '/home/ma-user/work/chenxiaolin/Image/'
    ...
    def _get_context_dialog(self, dialog):
        ...
        for each_img in imgs_list:  # self.image_content self.name_know_dict
            if each_img != 0:
                ...
                knowledge_keys = self.image_content[each_img]
                know_incor = []
                for knowledge_key in knowledge_keys:
                    if knowledge_key in self.name_know_dict.keys():
                        ...
                        know_incor.append(knowledge_value2)
                    else:
                        print(knowledge_key)
                        exit()
                know_incor_join = " ".join(know_incor)
                visual_know_list.extend([know_incor_join])
            else:
        ...
        for each_img_index in range(len(imgs_list)):
            ...
            if each_img!=0:
                ...
                # path_each_img = '/home/ma-user/work/chenxiaolin/example/example.png'
                ...
                text_vec_list[each_img_index] = each_img_vec  
