...
def text_valid(
    ...
    output_file_valid = open('text_244_valid.out', 'w')
    output_file_valid_name = 'text_244_valid.out'
    ...
    with torch.no_grad():
        for batch_id, valid_data in enumerate(valid_data_loader):
            ...
            text_decoder.text_generation(context, context2, texts1, id2word, output_file_valid, image_features, image_len, context_visual_know, text_visual_know)
